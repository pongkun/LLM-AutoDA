...
class RIDE(nn.Module):
    ...
    def forward(self, outputs, target, epoch=0, reduction='mean'):
        output_logits,extra_info = outputs["output"], outputs
        extra_info['logits'] =  extra_info['logits'].transpose(0,1)
