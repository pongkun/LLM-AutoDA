...
#                --aug_prob 0.5 --loss_fn ldam_drw --aug_type autoaug_cifar \
#                --cutout --doda \
#                > ./run/log/ldam_drw_doda.log 2>&1 
echo "PID:$$";
...
do 
    ...
    python main.py --dataset cifar100 --imb_ratio $1 --num_max 500 --epochs 200 \
               --batch-size 256 --gpu 2 --use_ael_reinforcement \
               --aug_prob 0.5 --loss_fn ldam_drw --aug_type autoaug_cifar \
               --seed $seed --AutoLT --cutout \
               > ./run/log/cifar100_ir=$1/ldam_drw_doda_$seed.log 2>&1 
done