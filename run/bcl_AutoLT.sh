...
#                --aug_prob 0.5 --loss_fn bcl --aug_type autoaug_cifar \
#                --cutout --doda \
#                > ./run/log/bcl_doda.log 2>&1 
echo "PID:$$";
...
do 
    ...
    python main.py --dataset cifar100 --imb_ratio $1 --num_max 500 --epochs 200 \
               --batch-size 256 --gpu 0 --use_ael_reinforcement  \
               --aug_prob 0.5 --loss_fn bcl --aug_type autoaug_cifar \
               --use_ael_reinforcement --seed $seed --AutoLT --cutout \
               > ./run/log/cifar100_ir=$1/bcl_doda_$seed.log 2>&1 
done