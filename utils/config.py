...
def parse_args(run_type = 'terminal'):
    ...
    parser.add_argument('--AutoLT', action='store_true', help='Use AutoLT')
    ...
    parser.add_argument('--use_ael_reinforcement', action='store_true', help='if_use ael')
    parser.add_argument('--ael_reinforcement_url', type=str, default='/home/zz/wang/Long-tailed/LLM-LT-AUG-main_ael/ael_results/pops_best/population_generation_01.json', help='Ael Url')
